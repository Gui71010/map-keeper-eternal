...
import areaTreinamentoImg from '@/assets/area-treinamento.jpg';
import areaMedicinaImg from '@/assets/area-medicina.jpg';
import areaCorporativoImg from '@/assets/area-corporativo.jpg';
import areaRecrutamentoImg from '@/assets/area-recrutamento.jpg';
import areaAdministrativoImg from '@/assets/area-administrativo.jpg';
          ...
          {areas.map((area, idx) => {
            ...
            return (
              ...
              >
                ...
                <div
                  className="relative rounded-2xl h-full transition-all duration-400 cursor-default overflow-hidden"
                  style={{
                    ...
                    background: 'linear-gradient(160deg, hsl(222, 40%, 11% / 0.85), hsl(215, 35%, 7% / 0.92))',
                  }}
                >
                  {/* Background image */}
                  <img
                  ...
                  <div className="absolute inset-0 bg-gradient-to-t from-card via-card/85 to-card/55 pointer-events-none" />

                  <div
                    className="absolute inset-0 rounded-2xl pointer-events-none transition-opacity duration-400"
                    style={{
                      opacity: isHovered ? 1 : 0,
                      background: `radial-gradient(circle at 30% 30%, ${area.glowColor}15, transparent 60%)`,
                    }}
                  />
                  ...
                  <div className="relative z-10 p-7">
                    ...
                    <p className="text-muted-foreground text-sm leading-relaxed opacity-85 group-hover:opacity-100 transition-opacity duration-300">
                      {area.description}
                    </p>
                  </div>
                </div>
