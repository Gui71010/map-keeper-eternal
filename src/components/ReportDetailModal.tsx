      ...
      <motion.div initial={{ scale: 0.9, opacity: 0 }} animate={{ scale: 1, opacity: 1 }} exit={{ scale: 0.9, opacity: 0 }} onClick={(e) => e.stopPropagation()} className="glass-card rounded-2xl w-full max-w-6xl h-[92vh] overflow-y-auto relative mx-14">
        ...
        <div className="p-6 md:p-8 grid md:grid-cols-2 gap-8 items-start">
          <div className="flex flex-col space-y-3">
            <div className="bg-muted rounded-xl overflow-hidden relative flex items-center justify-center" style={{ minHeight: '500px', maxHeight: '70vh' }}>
              {images[imgIndex] ? <img src={images[imgIndex]} alt="" className="w-full h-full object-cover absolute inset-0" style={{ minHeight: '500px' }} /> : <div className="w-full h-full flex items-center justify-center text-muted-foreground text-sm" style={{ minHeight: '500px' }}>Sem imagem</div>}
